        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-14 lg:gap-10">
            ...
            <div className="lg:col-span-5">
              <Link to="/" className="inline-flex items-center gap-3 mb-8 group" aria-label="CINELUX Home">
            ...
            <div className="lg:col-span-3">
              <h3 className="text-xs font-bold text-white mb-7 uppercase tracking-widest">Quick Links</h3>
            ...
            <div className="lg:col-span-4">
              <h3 className="text-xs font-bold text-white mb-7 uppercase tracking-widest">Contact Us</h3>
            ...
            <nav className="flex items-center gap-1" aria-label="Footer legal links">
              {bottomLinks.map(({ label, href }, i) => (
                <span key={label} className="flex items-center">
                  {i > 0 && <ChevronRight className="h-3 w-3 text-neutral-600 mx-1.5" />}
                  <a
                    href={href}
